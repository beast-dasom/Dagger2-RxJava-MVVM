...
class EditActivity : BaseActivity(), EditAdapter.ItemClickListener {
    ...
    @Inject lateinit var adapter: EditAdapter

    @Inject lateinit var viewModelFactory: EditViewModelFactory
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(
                this, viewModelFactory)[EditViewModel::class.java]
        ...
        with(rvActivitySearchList) {
            ...
            adapter = this@EditActivity.adapter
        }
...
//                }
    ...
    override fun onItemClick(repository: EditRepo) {
//        disposables += viewModel.addToSearchHistory(repository)
        startActivity<RepositoryActivity>(
                RepositoryActivity.KEY_USER_LOGIN to repository.name,
...
//        supportActionBar?.run { subtitle = newIntentquery }
    }
